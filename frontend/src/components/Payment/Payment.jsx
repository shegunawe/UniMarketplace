...
const PaymentInfo = ({
  ...
  const componentProps = {
    email: "aweshegun@gmail.com",
    amount: 384979*100,
    metadata: {
      name: "AWE OLUWASEGUN SUNDAY",
      phone: "08135200455",
    },
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div>
        ...
        {select === 2 ? (
          <PaystackButton 
            className={`${styles.button} !bg-[#f63b60] text-white h-[45px] rounded-[5px] cursor-pointer text-[18px] font-[600]`} {...componentProps} />
        ) : null}
      </div>
